...
<table>
  ...
  <tr>
    <td>1. You are logged in <br>2. You are currently on <strong>My Workspace</strong> page <br>3. You want to create content
      ...
      <td><img src="../images/contenteditor/profile1.png"></td>
  </tr>
  <tr>
    ...
    <td><img src="../images/contenteditor/create_studymaterial.png"></td>
  </tr>
  </table>
...
## Content Editor Parts
  ...
  <tr>
    ...
    <td><img src="../images/contenteditor/contenteditor1.png"></td>
  </tr>
  </table>
...
### Right pane
 ...
 <tr>
  ...
  <tr>
    ...
    <td><img src="../images/contenteditor/rightpane1.png"></td>
  </tr>
  </table>
 ...
 <tr>
  ...
  <tr>
    ...
    <td><img src="../images/contenteditor/rightpane2.png"></td>
  </tr>
  </table>
 ...
 <tr>
  ...
  <tr>
    ...
    <td><img src="../images/contenteditor/rightpane3.png"></td>
  </tr>
  </table>
...
page to reorder them
    ...
    <td><img src="../images/contenteditor/addslide.png"></td>
  </tr>
  </table>
...
#### Adding Text
  ...
  <tr>
    ...
    <td><img src="../images/contenteditor/addtext1.png"></td>
  </tr>
  </table>
  ...
  **Formatting Text - Customize tab**
  ...
  <tr>
    ...
    <td><img src="../images/contenteditor/addtext2.png"></td>
  </tr>
  </table>
  ...
  **Selecting Text for Read Along Audio**
  ...
  <tr>
    ...
    <td><img src="../images/contenteditor/textfor_readalongaudio.png"></td>
  </tr>
  </table>
  ...
  **Selecting Audio for Read Along Text**
  ...
  <tr>
    ...
    <td><img src="../images/contenteditor/audiofor_readalongtext.png"></td>
  </tr>
  </table>
  ...
  **Selecting Audio for Reading Along**
  ...
  <tr>
    ...
    <td><img src="../images/contenteditor/selectaudiofor_readingalong.png"></td>
  </tr>
  </table>
  ...
  **Sync Audio Text with Audio to Read Along**
  ...
  <tr>
    ...
    <td><img src="../images/contenteditor/synctextwithaudio.png"></td>
  </tr>
  </table>
  ...
  **Read Along - Highlighter**
  ...
  <tr>
    ...
    <td><img src="../images/contenteditor/readalong_highlighter.png"></td>
  </tr>
  </table>
...
words that already exist in the repository <br>1. To use this feature, select the word or paragraph in the text box <br>2. Click <strong>Done</strong> button <br>3. Click <strong>Word Info</strong> 
    ...
    <td><img src="../images/contenteditor/wordinfo1.png"></td>
  </tr>
  <tr>
    ...
    <td><img src="../images/contenteditor/wordinfo2.png"></td>
  </tr>
  </table>
  ...
  **Transliteration**
  ...
  <td>The process of changing the written script from one language to another is known as transliteration. On clicking Add text, the Transliterate feature on the customize tab allows you to transliterate in ten Indian languages <br>1. To transliterate, select the word or sentence and click <strong>Transliterate</strong></td>
    <td><img src="../images/contenteditor/transliteration.png"></td>
  </tr>
  <tr>
    ...
    <td><img src="../images/contenteditor/transliteration1.png"></td>
  </tr>
  </table>
...
#### Adding Richtext 
  ...
  <tr>
    ...
    <td><img src="../images/contenteditor/richtext1.png"></td>
  </tr>
  <tr>
    ...
    <td><img src="../images/contenteditor/richtext2.png"></td>
  </tr>
  </table>
...
the shape <br>b) Use the <b>Transparency</b> slider to modify the transparency level of the shape <br>c) Use the <b>Visible</b> slider to make the selected shape visible or invisible <br>d) Click <b>Border Color</b> to modify the color of the shape outline</td>
    <td><img src="../images/contenteditor/addshape.png"></td>
  </tr>
  </table>
...
#### Adding Images
  ...
  <tr>
    ...
    <td><img src="../images/contenteditor/addimage.png"></td>
  </tr>
  </table>
  ...
  **Selecting Images**
  ...
  <tr>
     ...
     <td><img src="../images/contenteditor/selectimage.png"></td>
  </tr>
  </table>
  ...
  **Uploading and Using Images**
  ...
  <tr>
    ...
    <td><img src="../images/contenteditor/uploaduse.png"></td>
  </tr>
  </table>
  ...
  **Formatting Images**
  ...
  <tr>
    ...
    <td><img src="../images/contenteditor/formatimage.png"></td>
  </tr>
  </table>
...
#### Adding Audio
  ...
  <tr>
    ...
    <td><img src="../images/contenteditor/addaudio.png"></td>
  </tr>
  </table>
...
#### Adding Hotspot
  ...
  <tr>
    ...
    <td><img src="../images/contenteditor/addhotspot.png"></td>
  </tr>
  </table>
  ...
  **Adding Action to the Hotspot**
  ...
  <tr>
    ...
    <td><img src="../images/contenteditor/hotspot_action.png"></td>
  </tr>
  </table>
...
#### Adding Scribblepad
 ...
 <table>
  ...
  <tr>
    ...
    <td><img src="../images/contenteditor/scribblepad.png"></td>
  </tr>
  </table>
...
<br>To ensure that the content achieves the learning objective it is important to check and reaffirm the learner’s progress at different points in the study material. Adding questions and question sets is one method <br>1. Click the <b>Add Question Set</b> icon on the toolbar
    ...
    <td><img src="../images/contenteditor/addquestionset.png"></td>
  </tr>
  </table>
...
<br>8. Click Next
  ...
  <td><img src="../images/contenteditor/selectquestions.png"></td>
</tr>
</table>
 ...
 <tr>
  ...
  <td><br>1.Select the type of question you want to create.
   ...
   <tr>
    ...
    <td><img src="../images/contenteditor/createquestion.png"> </td>
  </tr> 
 ...
 <td>Multiple Choice Questions
	...
	<br>7. Enter the score for each question using <b>Configure Score</b> 
	  ...
	  <br>9. Click <b>Add</b> to append the selected questions in Question Set. The Question Set is added on the slide.   
		...
		<td><img src="../images/contenteditor/configureques.png"></td>
	 </tr>
	 </table>
...
**Creating Fill in the Blanks Question Set **
	...
	<br>7. Enter the score for each question using <b>Configure Score</b> 
	  ...
	  <br>9. Click <b>Add</b> to append the selected questions in Question Set. The Question Set is added on the slide.   
		...
		<td><img src="../images/contenteditor/configurequeston.png"></td>
	 </tr>
	 </table>
...
**Customizing Question Set**
  ...
  <tr>
    ...
    <td><img src="../images/contenteditor/customizetab.png"></td>
  </tr>
  </table>      
...
**Configuring Question Set**
 ...
 <tr>
    ...
    <td><img src="../images/contenteditor/ques_set.png"></td>
 </tr>
 </table>   
...
#### Adding Activity
 ...
 <tr>
    ...
    <td><img src="../images/contenteditor/addactivity.png"></td>
 </tr>
 </table> 
 ...
 **Activity Browser**
 ...
 <tr>
    ...
    <td><img src="../images/contenteditor/activitybrowser.png"></td>
 </tr>
 </table> 
 ...
 <tr>
    <td>1. All details of the selected activity are displayed on the right <br>2. Click <strong>Add</strong> to add the activity</td>       <td><img src="../images/contenteditor/activitydetails.png"></td>
 </tr>
 </table>  
 ...
 <tr>
    ...
    <td><img src="../images/contenteditor/configureactivity.png"></td>
 </tr>
 <tr>
    ...
    <td><img src="../images/contenteditor/configureactivity1.png"></td>
 </tr>
 </table>
...
#### Adding Video
  ...
  <tr>
    ...
    <td><img src="../images/contenteditor.png"></td>
  </tr> 
  <tr>
    ...
    <td><img src="../images/contenteditor/addvideo.png"></td>
  </tr>
  </table>
  ...
  **Configuring Video Details**
  ...
  <tr>
    ...
    <td><img src="../images/contenteditor/videodetail.png"></td>
  </tr>
  </table>
...
### Reviewing and Publishing Content 
 ...
 <tr>
  ...
  <tr>
    ...
    <td><img src="../images/contenteditor/publish_review.png"></td>
  </tr>
  </table>
...
c) Subject <br>d) Grade <br>e) Audience <br>f) Resource Type <br>g) Concepts <br>4. Enter Attributions, if any <br>5. Enter Keywords <br><strong>Note:</strong> Keywords help search engines find content associated with them when you search <br>6. Click <strong>Save</strong>
    ...
    <td><img src="../images/contenteditor/addmetadata.png"></td>
  </tr>
  </table>   
